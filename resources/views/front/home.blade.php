...
<div class="container mt-4">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <p><strong>Nama Rumah Sakit :</strong> RS. Abu Hanifah</p>
                    <p><strong>Alamat :</strong> Jl. Pattimura No. 07, Kepulauan Meranti</p>
                    <p><strong>Nomor Telepon :</strong> (0761) 123456</p>
                    <p><strong>Email :</strong> info@rsabuhanifah.com</p>
                </div>
                <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <ul class="list-unstyled">
                ...
                <li><i class="bi bi-envelope-fill me-2"></i> info@rsabuhanifah.com</li>
